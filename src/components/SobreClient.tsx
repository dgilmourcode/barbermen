            ...
            >
              ...
              <div className="grid grid-cols-2 gap-3 mb-8">
                <div className="space-y-3">
                  <motion.div variants={fadeUp} className="overflow-hidden border border-bark/8 group">
                    <div className="relative h-64">
                      <img src="/images/gallery-1.jpg" alt="Corte clássico" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
                    </div>
                  </motion.div>
                  <motion.div variants={fadeUp} className="overflow-hidden border border-bark/8 group">
                    <div className="relative h-48">
                      <img src="/images/gallery-2.jpg" alt="Barba navalha" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
                    </div>
                  </motion.div>
                </div>
                <div className="space-y-3 pt-8">
                  <motion.div variants={fadeUp} className="overflow-hidden border border-bark/8 group">
                    <div className="relative h-48">
                      <img src="/images/gallery-3.jpg" alt="Ambiente" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
                    </div>
                  </motion.div>
                  <motion.div variants={fadeUp} className="overflow-hidden border border-bark/8 group">
                    <div className="relative h-64">
                      <img src="/images/gallery-4.jpg" alt="Acabamento" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
                    </div>
                  </motion.div>
                </div>
              </div>
